<script>
	...
	const wealthLookup = {
		...
		"8": {
			...
			"player2": 1200,
			"wager": 160,
			"player1Words": "That's too much. I lost last game, so I can only bet 20% of my money – $160.",
		...
		"10": {
			...
			"player2": 1360,
			"wager": 160,
			"player1Words": "Lost again. I'm down to $640.",
			"player2Words": "Two wins in a row, baby!",
			"player1Record": "0 - 2",
			"player2Record": "2 - 0"
		}
	}
